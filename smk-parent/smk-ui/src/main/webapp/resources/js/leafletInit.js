...
function addKmlLayer(serviceUrl, id, lmfId, attachmentId, cluster, heatmap, visible, style)
{
	var customLayer = L.geoJson(null, {
	    style: style
	});
	
	//var kmlToJsonLayer = omnivore.kml("./document.xhtml?lmfId=" + docId + "&attid=" + attachmentId + "&type=xml", null, customLayer);
	var kmlToJsonLayer = omnivore.kml(serviceUrl + lmfId + "/Attachments/" + attachmentId + "/", null, customLayer);
...
function addJsonLayer(serviceUrl, id, lmfId, attachmentId, cluster, heatmap, visible, style)
{
	...
	$.ajax(
	{
		...
		url: serviceUrl + docId + "/Attachments/" + attachmentId + "/",
		success: function(data) 
		{
